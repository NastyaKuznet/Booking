...
const (
	AuthService_Register_FullMethodName      = "/order.AuthService/Register"
	AuthService_Login_FullMethodName         = "/order.AuthService/Login"
	AuthService_ValidateToken_FullMethodName = "/order.AuthService/ValidateToken"
)
